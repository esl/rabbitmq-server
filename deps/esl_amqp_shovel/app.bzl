...
def all_beam_files(name = "all_beam_files"):
    ...
    erlang_bytecode(
        name = "behaviours",
        srcs = ["src/esl_amqp_shovel_behaviour.erl"],
        hdrs = [":public_and_private_hdrs"],
        app_name = "esl_amqp_shovel",
        dest = "ebin",
        erlc_opts = "//:erlc_opts",
    )
    erlang_bytecode(
        name = "other_beam",
        srcs = [
            "src/Elixir.RabbitMQ.CLI.Ctl.Commands.DeleteEslShovelCommand.erl",
            "src/Elixir.RabbitMQ.CLI.Ctl.Commands.RestartEslShovelCommand.erl",
            "src/Elixir.RabbitMQ.CLI.Ctl.Commands.EslShovelStatusCommand.erl",
            "src/esl_amqp091_shovel.erl",
            "src/esl_amqp10_shovel.erl",
            "src/esl_log_shovel.erl",
            "src/esl_amqp_shovel.erl",
            "src/esl_amqp_shovel_config.erl",
            "src/esl_amqp_shovel_dyn_worker_sup.erl",
            "src/esl_amqp_shovel_dyn_worker_sup_sup.erl",
            "src/esl_amqp_shovel_locks.erl",
            "src/esl_amqp_shovel_parameters.erl",
            "src/esl_amqp_shovel_status.erl",
            "src/esl_amqp_shovel_sup.erl",
            "src/esl_amqp_shovel_util.erl",
            "src/esl_amqp_shovel_worker.erl",
            "src/esl_amqp_shovel_worker_sup.erl",
        ],
        hdrs = [":public_and_private_hdrs"],
        app_name = "esl_amqp_shovel",
        beam = [":behaviours"],
...
def all_srcs(name = "all_srcs"):
    ...
    filegroup(
        name = "priv",
        srcs = ["priv/schema/esl_amqp_shovel.schema"],
    )
    ...
    filegroup(
        ...
        srcs = [
            ...
            "src/esl_log_shovel.erl",
            "src/esl_amqp_shovel.erl",
            "src/esl_amqp_shovel_behaviour.erl",
            "src/esl_amqp_shovel_config.erl",
            "src/esl_amqp_shovel_dyn_worker_sup.erl",
            "src/esl_amqp_shovel_dyn_worker_sup_sup.erl",
            "src/esl_amqp_shovel_locks.erl",
